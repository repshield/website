...
const plans = [
  ...
  },
  {
    ...
    badge: 'Most Popular',
    description:
      'For high-ticket businesses where a single unresolved negative review can stall a sale. Turns disputes into private retention opportunities before reputation damage occurs.',
    features: [
      'Up to 3 business locations',
      'Everything in Retail Core',
      'High-value dispute resolution workflow',
      'Private escalation before public damage',
      'High-ticket escalation alerts',
      'Mobile app (iOS & Android)',
      '3-Second Swipe Approval',
      'Priority support',
    ],
    roi: { acv: '₹5,000 – ₹25,000 per transaction', breakEven: '<1 transaction recovered/month' },
    cta: 'Start Free Trial',
    ctaHref: '#',
    highlighted: true,
    accent: '#2563EB',
